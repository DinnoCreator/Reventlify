      ...
      <div className="eddyContainer">
        ...
        <div className="flex-col justify-center items-center  mt-14 px-6  md:w-[35%] mx-auto">
          ...
          <form className="mt-6">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 1.0 }}>
              <div className="text-center text-white px-2 py-2 bg-blue-600 rounded-xl mt-3">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 1.0 }}>
              <Link to="/sign-up"><div className="text-center text-blue-600 px-2 py-2 border border-blue-600 rounded-xl mt-3 hover:cursor-pointer">
                Signup
              </div></Link>
            </motion.div>
          </form>
